    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="失物编号" prop="shiwubianhao">
          <el-input v-model="ruleForm.shiwubianhao" 
              placeholder="失物编号" clearable  :readonly="ro.shiwubianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="失物编号" prop="shiwubianhao">
              <el-input v-model="ruleForm.shiwubianhao" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="认领描述" prop="renlingmiaoshu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.renlingmiaoshu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.renlingmiaoshu" label="认领描述" prop="renlingmiaoshu">
                    <span v-html="ruleForm.renlingmiaoshu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.renlingshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.renlingshijian = true;
          ...
          if(o=='renlingmiaoshu'){
            this.ruleForm.renlingmiaoshu = obj[o];
	    this.ro.renlingmiaoshu = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.renlingmiaoshu = this.ruleForm.renlingmiaoshu.replace(reg,'../../../ssmauewu/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shiwurenling/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shiwurenlingCrossAddOrUpdateFlag = false;
                  this.parent.search();

<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="遗失时间" prop="yishishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.yishishijian" 
                type="datetime"
                placeholder="遗失时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yishishijian" label="遗失时间" prop="yishishijian">
              <el-input v-model="ruleForm.yishishijian" 
                placeholder="遗失时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="遗失地点" prop="yishididian">
          <el-input v-model="ruleForm.yishididian" 
              placeholder="遗失地点" clearable  :readonly="ro.yishididian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="遗失地点" prop="yishididian">
              <el-input v-model="ruleForm.yishididian" 
                placeholder="遗失地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用户" prop="yonghu">
          <el-input v-model="ruleForm.yonghu" 
              placeholder="用户" clearable  :readonly="ro.yonghu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用户" prop="yonghu">
              <el-input v-model="ruleForm.yonghu" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="遗失详情" prop="yishixiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.yishixiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yishixiangqing" label="遗失详情" prop="yishixiangqing">
                    <span v-html="ruleForm.yishixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wupintupian = true;
          ...
          if(o=='yishishijian'){
            this.ruleForm.yishishijian = obj[o];
	    this.ro.yishishijian = true;
            continue;
          }
          if(o=='yishididian'){
            this.ruleForm.yishididian = obj[o];
	    this.ro.yishididian = true;
            continue;
          }
          if(o=='zhanghao'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='yishixiangqing'){
            this.ruleForm.yishixiangqing = obj[o];
	    this.ro.yishixiangqing = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.yishixiangqing = this.ruleForm.yishixiangqing.replace(reg,'../../../ssmauewu/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wupinguashi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wupinguashiCrossAddOrUpdateFlag = false;
                  this.parent.search();

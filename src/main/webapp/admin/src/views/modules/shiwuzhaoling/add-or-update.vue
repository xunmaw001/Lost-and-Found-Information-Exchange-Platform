<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="失物编号" prop="shiwubianhao">
            <el-input v-model="ruleForm.shiwubianhao" 
                placeholder="失物编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shiwubianhao" label="失物编号" prop="shiwubianhao">
              <el-input v-model="ruleForm.shiwubianhao" 
                placeholder="失物编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="拾遗时间" prop="shiyishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.shiyishijian" 
                type="datetime"
                placeholder="拾遗时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shiyishijian" label="拾遗时间" prop="shiyishijian">
              <el-input v-model="ruleForm.shiyishijian" 
                placeholder="拾遗时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="拾遗地点" prop="shiyididian">
          <el-input v-model="ruleForm.shiyididian" 
              placeholder="拾遗地点" clearable  :readonly="ro.shiyididian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="拾遗地点" prop="shiyididian">
              <el-input v-model="ruleForm.shiyididian" 
                placeholder="拾遗地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="物品状态" prop="wupinzhuangtai">
          <el-select v-model="ruleForm.wupinzhuangtai" placeholder="请选择物品状态">
            <el-option
                v-for="(item,index) in wupinzhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="物品状态" prop="wupinzhuangtai">
	      <el-input v-model="ruleForm.wupinzhuangtai"
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wupintupian = true;
          ...
          if(o=='shiyishijian'){
            this.ruleForm.shiyishijian = obj[o];
	    this.ro.shiyishijian = true;
            continue;
          }
          if(o=='shiyididian'){
            this.ruleForm.shiyididian = obj[o];
	    this.ro.shiyididian = true;
            continue;
          }
          if(o=='wupinzhuangtai'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.wupinzhuangtaiOptions = "待认领,已认领".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssmauewu/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

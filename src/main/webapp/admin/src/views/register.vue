  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(25, 169, 123, 1);fontSize:28px;">失物招领信息交互平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.yonghu" class="input" type="text" placeholder="用户">
			   </div>
			 </div> -->
			<el-form-item label="用户" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.yonghu" autocomplete="off" placeholder="用户"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.yonghu) && `yonghu` == this.tableName){
